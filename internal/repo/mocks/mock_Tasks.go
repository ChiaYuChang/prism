...
// GetActivePageFetchTaskByURL provides a mock function for the type MockTasks
func (_mock *MockTasks) GetActivePageFetchTaskByURL(ctx context.Context, url string) (repo.Task, error) {
	ret := _mock.Called(ctx, url)

	if len(ret) == 0 {
		panic("no return value specified for GetActivePageFetchTaskByURL")
	}

	var r0 repo.Task
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (repo.Task, error)); ok {
		return returnFunc(ctx, url)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) repo.Task); ok {
...
// MockTasks_GetActivePageFetchTaskByURL_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetActivePageFetchTaskByURL'
type MockTasks_GetActivePageFetchTaskByURL_Call struct {
	*mock.Call
}

// GetActivePageFetchTaskByURL is a helper method to define mock.On call
//   - ctx context.Context
//   - url string
func (_e *MockTasks_Expecter) GetActivePageFetchTaskByURL(ctx interface{}, url interface{}) *MockTasks_GetActivePageFetchTaskByURL_Call {
	return &MockTasks_GetActivePageFetchTaskByURL_Call{Call: _e.mock.On("GetActivePageFetchTaskByURL", ctx, url)}
}

func (_c *MockTasks_GetActivePageFetchTaskByURL_Call) Run(run func(ctx context.Context, url string)) *MockTasks_GetActivePageFetchTaskByURL_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockTasks_GetActivePageFetchTaskByURL_Call) Return(task repo.Task, err error) *MockTasks_GetActivePageFetchTaskByURL_Call {
	_c.Call.Return(task, err)
	return _c
}

func (_c *MockTasks_GetActivePageFetchTaskByURL_Call) RunAndReturn(run func(ctx context.Context, url string) (repo.Task, error)) *MockTasks_GetActivePageFetchTaskByURL_Call {
	_c.Call.Return(run)
	return _c
}
