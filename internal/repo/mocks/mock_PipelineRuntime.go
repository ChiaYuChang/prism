...
func (_mock *MockPipelineRuntime) ListPipelineInputCandidates(ctx context.Context, rootBatchID uuid.UUID) ([]repo.PipelineInputMember, error) {
	...
	var r0 []repo.PipelineInputMember
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) ([]repo.PipelineInputMember, error)); ok {
		return returnFunc(ctx, rootBatchID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) []repo.PipelineInputMember); ok {
		r0 = returnFunc(ctx, rootBatchID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]repo.PipelineInputMember)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID) error); ok {
...
func (_c *MockPipelineRuntime_ListPipelineInputCandidates_Call) Return(pipelineInputMembers []repo.PipelineInputMember, err error) *MockPipelineRuntime_ListPipelineInputCandidates_Call {
	_c.Call.Return(pipelineInputMembers, err)
	return _c
}

func (_c *MockPipelineRuntime_ListPipelineInputCandidates_Call) RunAndReturn(run func(ctx context.Context, rootBatchID uuid.UUID) ([]repo.PipelineInputMember, error)) *MockPipelineRuntime_ListPipelineInputCandidates_Call {
	_c.Call.Return(run)
	return _c
}

// ListPipelineInputContents provides a mock function for the type MockPipelineRuntime
func (_mock *MockPipelineRuntime) ListPipelineInputContents(ctx context.Context, rootBatchID uuid.UUID) ([]repo.PipelineInputMember, error) {
	ret := _mock.Called(ctx, rootBatchID)
...
func (_c *MockPipelineRuntime_ListPipelineInputContents_Call) Return(pipelineInputMembers []repo.PipelineInputMember, err error) *MockPipelineRuntime_ListPipelineInputContents_Call {
	_c.Call.Return(pipelineInputMembers, err)
	return _c
}

func (_c *MockPipelineRuntime_ListPipelineInputContents_Call) RunAndReturn(run func(ctx context.Context, rootBatchID uuid.UUID) ([]repo.PipelineInputMember, error)) *MockPipelineRuntime_ListPipelineInputContents_Call {
	_c.Call.Return(run)
	return _c
}
