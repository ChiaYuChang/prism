...
func (_mock *MockTransformer) Transform(ctx context.Context, in string) (string, error) {
...
//   - ctx context.Context
//   - in string
func (_e *MockTransformer_Expecter) Transform(ctx interface{}, in interface{}) *MockTransformer_Transform_Call {
	return &MockTransformer_Transform_Call{Call: _e.mock.On("Transform", ctx, in)}
}

func (_c *MockTransformer_Transform_Call) Run(run func(ctx context.Context, in string)) *MockTransformer_Transform_Call {
...
func (_c *MockTransformer_Transform_Call) RunAndReturn(run func(ctx context.Context, in string) (string, error)) *MockTransformer_Transform_Call {
	_c.Call.Return(run)
	return _c
}
