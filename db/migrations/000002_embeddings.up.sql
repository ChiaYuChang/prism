...
CREATE INDEX idx_cemb_g25_vec ON candidate_embeddings_gemma_2025 USING hnsw (vector vector_cosine_ops);
...
CREATE INDEX idx_emb_g25_vec ON content_embeddings_gemma_2025 USING hnsw (vector vector_cosine_ops);
